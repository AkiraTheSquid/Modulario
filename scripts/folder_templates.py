"""Templates auto-created for monitored project folders."""
...
def readme_template(folder_name, created_date):
    return f"""{DOC_MARKER}
# {folder_name}
...
## Recent Changes
- {created_date}: Initial doc created.
"""


def watch_template(folder_name, parents):
